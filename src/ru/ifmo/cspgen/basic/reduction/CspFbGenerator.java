...
public class CspFbGenerator {
	...
	protected String modelFileName = "minizinc/model-multiple.mzn";
...
//		    new CspFbGenerator().run(args);
		new CspFbGenerator().run(new String[]{"-n", "10", "tests"});
//		new CspFbGenerator().run(new String[]{"-n", "15", "-p", "short-predicate-names", "-o", "short-output-variables", "tests"});
	}

	public CspFbGenerator() {
	}

	public CspFbGenerator(int statesCount, String scenariosFile) {
