...
public class CspFbGeneratorWithPassive {
	public class Tran {
	...
	public static void main(String args[]) {
		    new CspFbGeneratorWithPassive().run(args);
//		new NewCspFbGenerator().run(new String[]{"-n", "10", "tests"});
//		new CspFbGenerator().run(new String[]{"-n", "15", "-p", "short-predicate-names", "-o", "short-output-variables", "tests"});
	}

	public CspFbGeneratorWithPassive() {
	}

	public CspFbGeneratorWithPassive(int statesCount, String scenariosFile) {
...
//		scenarios = EccUtils.removePassiveElements(scenarios);
	...
	public String getDataString(ScenarioTree tree) {
		...
		sb.append(String.format("C = %d;\n" +
				...
				"O = %d;\n" +
				"L = %d;\n", 
				statesCount, tree.getNodesCount(), MultiMaskEfsmSkeleton.INPUT_EVENT_COUNT,
